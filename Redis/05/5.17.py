...
def in_a_not_in_b(class_a, class_b):
    students = client.sdiff(class_a, class_a)
    return len(students)
...
if __name__ == '__main__':
    ...
    print(f'当前选了math,没选computer的学生有：{in_a_not_in_b("math", "computer")}名学生至少选了一门课')
    print(f'当前选了math,也选了computer的学生有：{in_a_and_in_b("math", "computer")}名学生至少选了一门课')
    print(f'当前选了math,或者选了computer的学生有：{in_a_or_in_b("math", "computer")}名学生至少选了一门课')
